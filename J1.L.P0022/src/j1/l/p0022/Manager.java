...
public class Manager implements IManager {
    ...
    private Candidate commonUpdate(Candidate C, int type) throws ParseException {
        while (true) {
            ...
            int optionUpdate;
            if (type == 0) {
                optionUpdate = Common.inputInteger("Enter option: ", 1, 8);
            } else {
    ...
    private void updateMenu(int type) {
        ...
        switch (type) {
            case 0:
                System.out.println("6. Year of experience");
                System.out.println("7. Professional skill");
                System.out.println("8. Exit");
                break;
            case 1:
                System.out.println("6. Graduation date");
                System.out.println("7. Rank of graduation");
            ...
            case 2:
                ...
                System.out.println("8. University");
                System.out.println("9. Exit");
                break;
        }
    }
